          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salesData}>
                ...
                <Bar dataKey="value" fill="#6D0D26" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          <div className="flex items-center gap-2 mt-4">
            <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#6D0D26' }}></div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Track orders and profits over time period</p>
            </div>
            <div className="flex items-center gap-2">
              <select 
                value={ordersPeriod} 
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Keep track of vendors and their order status</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Keep track of top selling products among all orders</p>
            </div>
            <div className="flex items-center gap-2">
              <select 
